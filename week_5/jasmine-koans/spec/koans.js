...
describe("the JavaScript language", function(){
  ...
  describe("considers functions as first class citizens", function(){
    ...
    it("can invoke functions indirectly using the special 'call'", function(){
        ...
        expect(f.call(undefined,1,1)).toEqual(2);
    });
  ...
  describe("has multiple ways to define and create objects", function(){
    ...
    it("may define complex objects", function(){
        ...
        // the 4 lines above written in 1 line:
        // var user = { address: { street: "sesame" } };

        user.friends = [ {name: "triki"}, {name: "Marc"} ];
    ...
    it("may create objects also with the module pattern", function(){
        function createObject(initialScore, color){
          ...
          // Add the anonymous functions to the return objects
          //
          // return {
          //   color: color,
          ...
          // Assign the anonymous functions to variables first
          //
          var points = function () { return score; };
          var increment = function (arg) { score = arg + score; };

          return {
            color: color,
            points: points,
            incrementScoreIn: increment
          };
        }
